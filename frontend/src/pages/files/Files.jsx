    ...
    return (
        <div>
            ...
            <div className="mb-4 flex items-center gap-3">
                <label className="cursor-pointer inline-flex items-center gap-2 px-4 py-2 bg-base-200 text-gray-200 rounded-md border border-black/20 hover:bg-base-300 transition text-sm">
                ...
                <button
                    ...
                    className="px-4 py-2 bg-accent text-black rounded-md text-sm font-medium hover:brightness-95 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
